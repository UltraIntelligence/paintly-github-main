...
import { EventAdditionalInfo } from "@/components/events/event-additional-info"
    ...
    <div className="@container/main flex flex-1 flex-col">
      <div className="flex flex-col p-4 md:p-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>{eventDetailData.name.en}</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <EventPerformance
              performance={eventDetailData.performance}
              topLocations={eventDetailData.topLocations}
              topInstructors={eventDetailData.topInstructors}
            />
        ...
        <div className="mt-6 grid grid-cols-1 gap-6">
          <EventAdditionalInfo
            materials={eventDetailData.materials}
            specialInstructions={eventDetailData.specialInstructions}
            internalNotes={eventDetailData.internalNotes}
            isTemplate={isTemplate}
            templateUsage={eventDetailData.templateUsage}
          />
        </div>
      </div>
    </div>
